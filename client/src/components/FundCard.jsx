...
function FundCard({ owner, title, description, target, deadline, amountCollected, image, handleClick }) {
	...
	return (
		<div className="w-full rounded-[15px] bg-[#1c1c24] hover:cursor-pointer sm:w-[288px]" onClick={handleClick}>
			...
			<div className="flex flex-col p-4">
				...
				<div className="flex justify-between flex-wrap mt-[15px] gap-2">
					<div className="flex flex-col">
						...
						<p className="mt-[3px] font-epilogue font-normal text-[12px] leading-[18px] text-[#808191] truncate sm:max-w-[120px]">
							Raised of {target}
						</p>
					</div>
